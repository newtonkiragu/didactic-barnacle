...
new Vue({
  ...
  created() {
    this.createFolder("Mirep", null)

    this.createFile("index.html (you are here)", "Mirep")
    this.createFolder("page1", "Mirep")
    this.createFile("index.html", "page1")
    this.createFolder("js", "Mirep")
    ...
    this.createFolder("img", "Mirep")
    this.createFile("300.jpeg", "img")
    this.createFolder("css", "Mirep")
